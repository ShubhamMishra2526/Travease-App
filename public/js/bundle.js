...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY29kZXNodWJoY3BwMjUyNiIsImEiOiJjbWJybGl1OWswOHByMmlzNzM4cm8ybjhuIn0.WJRgkqY4B1I6CFXXCefvCw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/codeshubhcpp2526/cmbrmb3jz00z101sdh6pnfcps',
    // style URL
    // zoom: 5,
    scrollZoom: false
  });
...
var stripe = Stripe('pk_test_51Rae0fSHI3nBte57WRvyNftdcIYSLkvjQo1SXX1v1mcwMrd35mtGX6vqvUmIVLstYjGLG8gGl3XxTgqaqpwvhO0a00QsQAfktI');
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("/api/v1/booking/checkout_session/".concat(tourId));
        case 1:
          session = _context.v;
          console.log(session);
        ...
        case 3:
          ...
          _t = _context.v;
          console.log(_t);
          (0, _alert.showAlert)('error', ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || _t.message || 'Something went wrong during checkout.');
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[0, 3]]);
...
var userPasswordChange = document.querySelector('.form-user-settings');
...
if (userPasswordChange) userPasswordChange.addEventListener('submit', /*#__PURE__*/function () {
